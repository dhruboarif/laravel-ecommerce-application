      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li>
              <a href="{{ route('product.index') }}"><i class="fa fa-circle-o"></i> View Products</a>
            </li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li>
              <a href="{{ route('admin.allorder') }}"><i class="fa fa-circle-o"></i> All Order</a>
            </li>
            <li>
              <a href="{{ route('product.index') }}"><i class="fa fa-circle-o"></i> View </a>
            </li>
          </ul>
        </li>
