        ...
        <div class="single-top-main">
            ...
            <div class="col-md-7 single-top-left ">
                ...
                <h3>{{ $product_details->product_name }}</h3>
                 ...
                 <div class="pr-single">
                  <p class="reduced "><del>৳{{ $product_details->product_base_price }}</del>৳{{ $product_details->product_offer_price }}</p>
                </div>
                <div class="block block-w3">
                    <div class="starbox small ghosting"> </div>
                </div>
                <p class="in-pa"> {{ $product_details->product_short_description}} </p>
